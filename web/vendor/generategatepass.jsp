...
<div>
  <form method="POST" action="GenerateGatepass">
    <label for="fname">Enter UID</label>
    <input type="text2" id="uid" name="UID" placeholder="Student UID">
    
    <input type="submit2" value="Fetch" onclick="fetchdata('STUDENT')">
    ...
    <input type="datetime-local" id="startdate" name="startdate" placeholder="Start date">
    
    
    <label for="fname">End Date</label>
    <input type="datetime-local" id="enddate" name="enddate" placeholder="End date">
  
    <input type="submit" value="Generate Gatepass">
  </form>
</div>
        </div>
    </div>
