...
<body>
    ...
    <div class="wrapper">
        ...
        <table>
            ...
            <%
                String url = "jdbc:oracle:thin:@campusbuddy.cobq4isl2ziw.us-east-1.rds.amazonaws.com:1521:ORCL";
                String userName = "campusbuddy";
                String password = "campusbuddy123";  
               ...
               ResultSet rs = null;
               try {
                   String sql = ("select * from gatepasses where status = ?");
