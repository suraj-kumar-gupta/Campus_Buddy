...
<div>
  <form method="POST" action="DeleteWarden">
    ...
    <input type="text" id="mobile" name="usrtel" placeholder="Contact number">
    ...
    <input type="submit" value="Delete Warden">
  </form>
</div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function processResponse(responseXML) {
            ...
            if (status == "FAILURE") {
                ...
                document.getElementById("mobile").value = xmlDoc.getElementsByTagName("MOBILE")[0].childNodes[0].nodeValue;
