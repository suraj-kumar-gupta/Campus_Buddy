...
public class ModifyStudent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(DatabaseDAO.modifyStudent(student)){
                
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Student Details Modified Successfully');");
                ...
                out.println("</script>");
                    ...
                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('Unable to modify student');");
                    out.println("location='ModifyStudent.jsp';");
                    out.println("</script>");
                }
