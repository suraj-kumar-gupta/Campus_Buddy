 ...
 * @author xsura
 */
@WebServlet(name = "WardenLogin", urlPatterns = {"/WardenLogin"})
public class WardenLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(DatabaseDAO.validateWarden(warden)){
                ...
                out.println("<script type=\"text/javascript\">");
                    ...
                    out.println("location='WardenLogin.jsp';");
                    out.println("</script>");
                }
                    
                  } catch (SQLException ex) {
                Logger.getLogger(WardenLogin.class.getName()).log(Level.SEVERE, null, ex);
            }
